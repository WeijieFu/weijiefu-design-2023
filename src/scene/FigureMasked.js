...
import { useGLTF, useMatcapTexture, useMask } from "@react-three/drei"

export default function FigureMasked({ invert, ...props }) {
  const { nodes, materials } = useGLTF("/assets/model/figure.glb")
  const [matcap, url] = useMatcapTexture("3E2335_D36A1B_8E4A2E_2842A5")
  ...
  return (
    <group {...props} dispose={null} ref={figure}>
      <mesh geometry={nodes.Ear.geometry}>
        <meshMatcapMaterial matcap={matcap} {...stencil} />
      </mesh>
